...
#define	MAX_STEP 12787500
#define FREQ_BASE_MIN 480000000UL
#define FREQ_BASE_MAX 485000000UL
#define FREQ_OUT_MIN 480000000UL
#define FREQ_OUT_MAX 490000000UL
#define FREQ_BASE_DEFAULT 480000000
